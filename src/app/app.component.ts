...
export class AppComponent {
  ...
  keywordsList: any =
    [
      ...
      { sentence: " Wednesday is hump day, but has anyone asked the camel if he’s happy about it?" },
      { sentence: " Last Friday in three week’s time I saw a spotted striped blue worm shake hands with a legless lizard" },
      ...
      { sentence: "I was never good at Chemistry classes" },
      { sentence: "Everyone was busy, so I went to the movie alone" },
      { sentence: "I love eating toasted cheese and good tuna sandwiches" },
      { sentence: "Where do random thoughts come from?" },
      { sentence: "I really want to go to work, but I am too sick to drive" },
      { sentence: "Is it free?" },
      { sentence: "Do you know any good movies to watch?" },
      ...
      { sentence: " The body may perhaps compensates for the loss of a true metaphysics" },
      ...
      { sentence: " How was the math test?" }
    ];
}
